...
<table border="1" class="tab2">
	...
	int no=0;
	try{
		String sql="select m.custno,m.custname,m.grade,sum(n.price) from member0727 m, money0727 n where n.custno=m.custno group by m.custno,m.custname,m.grade order by sum(n.price)desc";
